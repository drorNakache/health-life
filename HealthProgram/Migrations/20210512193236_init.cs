    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EatingReport", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeightReport", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SnacksId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyGoal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyGoal_Meal_BreakFastId",
                        column: x => x.BreakFastId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyGoal_Meal_DinnerId",
                        column: x => x.DinnerId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyGoal_Meal_LaunchId",
                        column: x => x.LaunchId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyGoal_Meal_SnacksId",
                        column: x => x.SnacksId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EatingReportId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Food_EatingReport_EatingReportId",
                        column: x => x.EatingReportId,
                        principalTable: "EatingReport",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyGoal_BreakFastId",
                table: "DailyGoal",
                column: "BreakFastId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyGoal_DinnerId",
                table: "DailyGoal",
                column: "DinnerId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyGoal_LaunchId",
                table: "DailyGoal",
                column: "LaunchId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyGoal_SnacksId",
                table: "DailyGoal",
                column: "SnacksId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Food_EatingReportId",
                table: "Food",
                column: "EatingReportId");
